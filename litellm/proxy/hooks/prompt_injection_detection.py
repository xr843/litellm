...
class _OPTIONAL_PromptInjectionDetection(CustomGuardrail):
    ...
    def should_run_guardrail(self, data, event_type: GuardrailEventHooks) -> bool:
        """
        Prompt injection detection should not be bypassed by disable_global_guardrail.

        Only check event_hook matching - skip the disable_global_guardrail check
        that the parent class performs.
        """
        return self._event_hook_is_event_type(event_type=event_type)
